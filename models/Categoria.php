<?php
    class Categoria extends Conectar{
        ...
        public function insert_categoria($cat_nom,$cat_codigo){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO tm_categoria (cat_id, cat_nom,cat_codigo,fech_crea, est) VALUES (NULL,?,?,now(),'1');";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1, $cat_nom);
            $sql->bindValue(2, $cat_codigo);
            $sql->execute();
