    ...
    class Conectar{
        ...
        protected function Conexion(){
            try {
				...
				$conectar = $this->dbh = new PDO("mysql:local=localhost;dbname=fb_certificados","root","Fri5698**");
                /*TODO: Cadena de Conexion Produccion*/
				//$conectar = $this->dbh = new PDO("mysql:local=localhost;dbname=acadlider_fb_certificados","acadlider_fridel","Liderempatia23");
				return $conectar;
			} catch (Exception $e) {
        ...
        public static function ruta(){
            //QA
            return "http://localhost/sistema-certificados/";
            //Produccion
            //return "http://academialider.com.bo/certificados/";
        }
