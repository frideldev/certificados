        ...
        <div class="modal-content bd-0">
            ...
            <form method="post" id="cursos_form">
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Membrete Inicial del Certificado: <span class="tx-danger">*</span></label>
                            <textarea class="form-control " id="cur_memb" type="text" name="cur_memb"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Descripcion: <span class="tx-danger">*</span></label>
                            <textarea class="form-control " id="cur_descrip" type="text" name="cur_descrip"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Vigencia del Curso: <span class="tx-danger">*</span></label>
                            <select class="form-control select2" style="width:100%" name="vigencia" id="vigencia" data-placeholder="Seleccione">
                                <option label="Seleccione"></option>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Tipo de Pago del Curso: <span class="tx-danger">*</span></label>
                            <select class="form-control select2" style="width:100%" name="cur_pago" id="cur_pago" data-placeholder="Seleccione">
                                <option label="Seleccione"></option>
