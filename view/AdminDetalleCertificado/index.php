        ...
        <div class="br-section-wrapper">
            ...
            <div class="form-layout">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <label class="form-control-label">&nbsp;</label>
                        <button class="btn btn-outline-primary form-control" id="add_button" onclick="certificadovarios()"><i class="fa fa-plus-square mg-r-10"></i> PDF</button>
                    </div>
                    <div class="col-lg-3">
                        <label class="form-control-label">&nbsp;</label>
                        <button class="btn btn-outline-primary form-control" id="add_button" onclick="enviarCorreo()"><i class="fa fa-plus-square mg-r-10"></i> Correo</button>
                    </div>
                </div>
            </div>
